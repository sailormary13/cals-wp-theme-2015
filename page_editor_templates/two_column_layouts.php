										    ...
										    <g id="Home-page" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<?php	 } else if( get_row_layout() == 'title_text' ) { ?>
													 ...
													 <?php } else if( get_row_layout() == 'button' ) { ?>
															...
															<?php $buttonwindow = get_sub_field("open_in_a_new_window"); ?>

															<?php $buttonlink = get_sub_field("button_action");
																if($buttonlink == "page") { ?>


																<a href="<?php the_sub_field("link_to_page"); ?>" <?php if($buttonlink == "newwindow") ?> target="_blank" class="button blue"><?php the_sub_field("button_text"); ?></a>
															<?php } else if($buttonlink == "file") { ?>
																<a href="<?php the_sub_field("link_to_file"); ?>" class="button blue"><?php the_sub_field("button_text"); ?></a>
															<?php } else { ?>
																<a href="<?php the_sub_field("button_link"); ?>" class="button blue"><?php the_sub_field("button_text"); ?></a>
