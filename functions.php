...
$customacfcheck = get_theme_mod('uw-madison-wp-2015_global_options_acf_id');
...
$wp_customize->add_section( 'uw-madison-wp-2015-global-options' , array(
    	'title'      => __( 'Global Options', 'uw-madison-wp-2015' ),
    	'priority'   => 100,
) );

$wp_customize->add_section( 'uw-madison-wp-2015-alert-options' , array(
	'title'      => __( 'Alerts', 'uw-madison-wp-2015' ),
	'priority'   => 50,
) );
...
$wp_customize->add_setting('uw-madison-wp-2015_global_options_acf_id', array(
    'capability'     => 'edit_theme_options',
    'type'           => 'theme_mod',
));


$wp_customize->add_control('uw-madison-wp-2015-global-options-acf', array(
    'label'      => __('Disable built in theme ACF', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-global-options',
    'type'    => 'checkbox',
    'settings'   => 'uw-madison-wp-2015_global_options_acf_id',
    'priority'   => 2,
));
...
$wp_customize->add_setting('uw-madison-wp-2015_alert_enabled_id', array(
    'capability'     => 'edit_theme_options',
    'type'           => 'theme_mod',
));


$wp_customize->add_control('uw-madison-wp-2015_alert_enabled', array(
    'label'      => __('Alert Disabled', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-alert-options',
    'type'    => 'checkbox',
    'settings'   => 'uw-madison-wp-2015_alert_enabled_id',
    'priority'   => 2,
));


$wp_customize->add_setting('uw-madison-wp-2015_alert_message2_id', array(
    'capability'     => 'edit_theme_options',
	'type'           => 'theme_mod'
...
$wp_customize->add_control('uw-madison-wp-2015_alert_message', array(
    'label'      => __('Additional Alert Message', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-alert-options',
	'type'       => 'textarea',
    'settings'   => 'uw-madison-wp-2015_alert_message2_id',
    'priority'   => 2,
));



/*$wp_customize->add_setting('uw-madison-wp-2015_alert_link_id', array(
    'capability'     => 'edit_theme_options',
	'type'           => 'theme_mod'
...
$wp_customize->add_control('uw-madison-wp-2015_alert_link', array(
    'label'      => __('Link to more information', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-alert-options',
	'type'    => 'text',
    'settings'   => 'uw-madison-wp-2015_alert_link_id',
    'priority'   => 2,
));

$wp_customize->add_setting('uw-madison-wp-2015_alert_linktext_id', array(
    'capability'     => 'edit_theme_options',
	'type'           => 'theme_mod'
));


$wp_customize->add_control('uw-madison-wp-2015_alert_linktext', array(
	'label'      => __('Link Text'),
    'section'    => 'uw-madison-wp-2015-alert-options',
    'type'    => 'text',
    'settings'   => 'uw-madison-wp-2015_alert_linktext_id',
    'priority'   => 2,
));*/


$wp_customize->add_setting('uw-madison-wp-2015_alert_sticky_id', array(
    'capability'     => 'edit_theme_options',
    'type'           => 'theme_mod',
));


$wp_customize->add_control('uw-madison-wp-2015_alert_sticky', array(
    'label'      => __('Pin Alert to the top of the screen', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-alert-options',
    'type'    => 'checkbox',
    'settings'   => 'uw-madison-wp-2015_alert_sticky_id',
    'priority'   => 2,
));


$wp_customize->add_setting('uw-madison-wp-2015_alert_dismiss_id', array(
    'capability'     => 'edit_theme_options',
    'type'           => 'theme_mod',
));


$wp_customize->add_control('uw-madison-wp-2015_alert_dismiss', array(
    'label'      => __('Turn off User Dismissable', 'uw-madison-wp-2015'),
    'section'    => 'uw-madison-wp-2015-alert-options',
	'type'    => 'checkbox',
    'settings'   => 'uw-madison-wp-2015_alert_dismiss_id',
    'priority'   => 2,
));
...
$wp_customize->add_setting('uw-madison-wp-2015_dropdowns_overview_id', array(
    'capability'     => 'edit_theme_options',
    'type'           => 'theme_mod',
    'default'		 => 'disabled',
    'sanitize_callback' => 'sanitize_dropdown_options'
...
$wp_customize->add_control('uw-madison-wp-2015-dropdowns-overview', array(
	'label'      => __('Overview Links', 'uw-madison-wp-2015'),
	'description' => 'Allow overview links to be auto generated.',
    'section'    => 'uw-madison-wp-2015-navigation-options',
    'type'    => 'radio',
    'choices' => array(
            'enabled' => __( 'Enabled', 'uw-madison-wp-2015' ),
    ...
    'settings'   => 'uw-madison-wp-2015_dropdowns_overview_id',
));
...
function uw_madison_wp_2015_scripts() {
	...
	wp_enqueue_style( 'uw-madison-wp-2015-style', get_stylesheet_uri(), array(), '2.5.1', false );
